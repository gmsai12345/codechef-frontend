...
const AppointmentForm = ({ service, servicesOptions }: AppointmentFormProps) => {
  ...
  const onFinish = async(values: any) => {
    console.log('Received values of form: ', values,session);
    const respoonse = await axios.post('https://codechef-backend.vercel.app/api/appoinments', {
        "user_id":session?.user?.email,
        "appointment_id":crypto.randomUUID(),
        "doctor_id":'saidhakshan4@gmail.com',
        "title":"Sample",
        "description":"Sample desctription",
        "start_datetime":"2022-01-12T02:33:23.067Z"
    })
    console.log(respoonse, session)  
